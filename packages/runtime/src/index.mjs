...
import { browserError, captureOptions, copyBytes, createRuntimeModule, MixtureRuntimeError } from './runtime.mjs';
...
export async function loadRuntime(options = {}) {
  ...
  try {
    ...
    url = bytes ? null : input === undefined
      ...
      : new URL(input, globalThis.location?.href ?? import.meta.url);
