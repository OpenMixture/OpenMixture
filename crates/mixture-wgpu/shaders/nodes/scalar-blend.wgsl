...
fn scalar_blend(@builtin(global_invocation_id) id: vec3<u32>) {
    ...
    var value = a;
    if parameters.weight == 1.0 { value = b; }
    else if parameters.weight != 0.0 { value = clamp(a + (b - a) * parameters.weight, 0.0, 1.0); }
