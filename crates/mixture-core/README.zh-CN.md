...
本地 0.3.0 包处于 pre-alpha，仍禁用发布。已实现十三种 Core 节点契约；文档版本为 1，计划版本为 2。图像上传／执行由 mixture-wgpu 负责。明确拒绝不支持的输入。见仓库[兼容性策略](https://github.com/OpenMixture/OpenMixture/blob/main/docs/compatibility.zh-CN.md)与[本地包验证](https://github.com/OpenMixture/OpenMixture/blob/main/docs/package-consumption.zh-CN.md)。
