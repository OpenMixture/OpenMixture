...
本地 0.2.0 包处于 pre-alpha，仍禁用发布。已实现十二种带版本的节点契约；文档版本和计划版本仍为 1。明确拒绝不支持的输入。见仓库[兼容性策略](https://github.com/OpenMixture/OpenMixture/blob/main/docs/compatibility.zh-CN.md)与[本地包验证](https://github.com/OpenMixture/OpenMixture/blob/main/docs/package-consumption.zh-CN.md)。
