...
The local 0.2.0 package is pre-alpha and publication remains disabled. Eleven versioned node contracts are implemented; document version and plan version remain 1. Reject unsupported inputs explicitly. See the repository's [compatibility policy](https://github.com/OpenMixture/OpenMixture/blob/main/docs/compatibility.md) and [local package verification](https://github.com/OpenMixture/OpenMixture/blob/main/docs/package-consumption.md).
