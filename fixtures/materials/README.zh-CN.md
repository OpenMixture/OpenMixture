...
PR-008 添加[釉面陶瓷](./glazed-ceramic/README.zh-CN.md)、四个 1K 通道、两个参数变体及受保护基准工具。PR-009 添加[皮革候选](./leather/README.zh-CN.md)、三个新节点及受控观感证据，人工验收已获用户接受。PR-010 添加[方向性木材](./wood/README.zh-CN.md)、四组 1K 案例与 2K 实测追踪；木材人工接受已记录。人工审查与机器检查分别记录，远端 CI 保持暂缓。
