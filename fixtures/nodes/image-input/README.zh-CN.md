...
**M6A-03：** `cargo xtask test-node image-input` 现运行生产着色器。固定字节／方向／渐变／填充、混合端点和生命周期用例位于 [image_probe.rs](../../../crates/mixture-wgpu/tests/support/image_probe.rs)，详见 [Native 实现](../../../docs/m6a-03-native-resources.zh-CN.md)。下方 M6A-02 说明保留历史状态。
