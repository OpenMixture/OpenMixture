...
[M6A-02](./docs/m6a-02-core-resources.md) adds the thirteenth Core node contract, image-input, immutable resource preparation and plan v2; GPU image upload remains M6A-03 work. Rust source is 0.3.0 and the browser candidate is 0.3.0-alpha.0/API schema 2, both unpublished; the exact published npm version remains 0.2.0-alpha.0.
