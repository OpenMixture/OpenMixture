...
[ENG-04 Scalar composition](./docs/eng-04-scalar-blend.md) now adds the twelfth node; [browser 0.2.0-alpha.0 is published](./docs/evidence/npm-020-alpha/README.md). Rust 0.2.0 remains unpublished.
