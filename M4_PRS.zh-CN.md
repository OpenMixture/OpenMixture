...
**历史编号：** `PR-011` 至 `PR-015` 标识实施批次，不是 GitHub PR 编号。其带日期的完成记录保持不变；新工作按照[治理规则](./docs/governance.zh-CN.md)使用真实 GitHub PR。

**状态：** 依据 `e9dd03b` 的 [M3 评审](./docs/m3-review.zh-CN.md)启动，日期 2026-09-08。PR-011 至 PR-015 已本地实现并验证。[M4 退出／发布评估](./docs/release.zh-CN.md)记录本地验收及随后完成的远端门槛。本计划具体落实 [M4](./ROADMAP.zh-CN.md#m4--稳定的原生-sdk)，不改变架构或扩展节点词汇。[远端平台 CI](./docs/evidence/remote-ci/README.zh-CN.md)随后在 `8b43c84` 通过；下述历史本地完成记录保持不变。
