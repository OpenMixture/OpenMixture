...
The [MAT-02 preparatory design](./docs/mat-02-layered-weathering.md) is a draft, not an admitted node or accepted material. It proposes bounded axial Scalar morphology and saturating subtraction owned by Core/wgpu and reuses existing composition. MAT-01 exit and MAT-02a catalog/version/qualification-plan acceptance remain prerequisites to implementation. No runtime, format or migration rule changes in this preparation; check paired documentation/links and preserve the existing six gates.
