...
**M6B-03 已实现：** [共享 CPU codec](./docs/m6b-03-cpu-assets.zh-CN.md)提供规范 USTAR 写入、借用/拥有装载、完整性/闭包检查及 Core 准备；独立 Native 和归档消费者覆盖所有权与预算。源码推进至未发布的 Rust 0.5.0 / browser 0.5.0-alpha.0。下一项 **M6B-04：CLI/浏览器适配**，综合像素验收仍属 M6B-05。
...
| 当前增量 | M6-B：M6B-01/02 设计及 M6B-03 CPU codec 已在评审分支实现；下一项 M6B-04 适配，随后 M6B-05 验收。 |
