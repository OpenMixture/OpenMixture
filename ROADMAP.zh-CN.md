...
下一目标是可独立使用和验证的 SDK，随后交付一个有界材质表达增量。保持一个主要功能增量加必要维护的节奏。本批按 ENG-01、ENG-02 的顺序落实文档及规则／测试变更。ENG-03 现提供下方独立 SDK 入口；ENG-04 已有独立的拟议契约，实现及像素验收仍待完成。完成结论仍须绑定各工作项证据。
