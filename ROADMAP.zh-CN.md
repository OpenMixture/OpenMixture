...
**M6B-04 已实现：** [CLI/浏览器适配](./docs/m6b-04-adapters.zh-CN.md)共用 CPU codec，提供显式文件打包/检查/渲染及有界公共字节 API。Rust 0.5.0 / browser 0.5.0-alpha.0 仍未发布。下一项：**M6B-05 验收与收尾**。
...
| 当前增量 | M6-B：M6B-01/02 设计、M6B-03 codec 与 M6B-04 适配已在评审分支实现；下一项 M6B-05 验收。 |
