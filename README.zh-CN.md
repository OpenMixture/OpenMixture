...
**当前状态（2026-09-20）：** 原生 M4／M4.1、有界 M5、记录范围内的 Studio MVP 及普通 Windows Chrome／Edge／Firefox 验收已完成。软件包未发布。下一步是准确 Alpha 候选、Studio 升级验收及浏览器必需检查决策。[Alpha 收口](./docs/browser-alpha.zh-CN.md)负责当前工作；不启动 M6。
