...
[验收已完成](./evidence/m6b-05/README.zh-CN.md)，范围为记录的 Linux 软件矩阵：16 个包通道比较精确一致，六项必需检查全部通过。本切片仅改变消费者测试/工具，保持包 v1、文档 v1、计划 v2、API schema 2 及 fractal-noise v1。Rust 0.5.0 / npm 0.5.0-alpha.0 仍未发布。链接记录绑定精确被测提交/归档，后续文档提交不替代该身份。
