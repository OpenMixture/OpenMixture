...
ENG-03 在固定 Studio 验收前增加[独立 SDK 候选与精确注册表消费](../examples/browser-consumer/README.zh-CN.md)。其九项小型公开 API 测试补充材质矩阵，不替代任何材质、生命周期、部署或产品测试。两种模式的回执和浏览器报告均由已有 job artifact 保留。
