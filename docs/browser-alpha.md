...
**ALPHA-03 follow-up, 2026-09-17:** Chrome/Edge full-material certification remains pending. The [arithmetic reduction and contract review](./evidence/chromium-arithmetic-reduction/README.md) reproduces a WGSL-permitted multiply/add difference and traces half-rounding propagation. It supersedes the proposed dependency-maintenance route: retain existing references and gates, evaluate numerical stability before deciding on a shader or compiler-policy change, and do not treat diagnostic pixel matches as certification.
