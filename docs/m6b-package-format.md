...
**Selected design, 2026-09-22; implementation pending M6B-03/04.** [ADR 0008](./decisions/0008-portable-assets.md) and this contract complete the format-selection slice of [M6-B](./m6b-portable-assets.md). Integration accepts the design, not a working loader or release. No product API, crate, dependency or version changes in this PR.
