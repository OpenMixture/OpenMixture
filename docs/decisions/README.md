...
| [0009](./0009-transient-texture-reuse.md) | Per-render last-use planning and compatible texture slots | Accepted design; 0.8 working implementation, full qualification pending |
