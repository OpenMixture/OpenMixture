...
**Working MAT-02b candidate (2026-09-23):** Source manifests select unpublished Rust 0.7.0 / browser 0.7.0-alpha.0 for scalar-morphology@1 and scalar-subtract@1, admitted by the [integrated contract](./mat-02-layered-weathering.md). The catalog has seventeen types/fifteen kernels. Downstream exhaustive Rust matches must handle ScalarMorphology and ScalarSubtract. Node/public-consumer qualification and painted-metal material acceptance remain pending; the last qualified MAT-01 baseline is 0.6. Formats, existing semantics, historical failures, migration policy and publication remain unchanged.
