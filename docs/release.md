...
**Brick-pattern candidate:** Rust 0.6.0 and browser 0.6.0-alpha.0 add the new exhaustive plan variants and reviewed node catalog. Both are unpublished; published browser remains 0.3.0-alpha.0. M6-B and NUM-01 are integrated in the source baseline. [Contract and required qualification](./brick-pattern.md) define this increment. Earlier receipts below do not certify this candidate.
