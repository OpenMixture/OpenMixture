...
export async function stage(packageDirectory, product, output, revision, consumerRevision) {
  ...
  await save(join(output, 'consumer-compatibility.json'), { consumerRevision,
    ...
    reason: 'Brick pattern: fourteen reviewed Core contracts, unpublished runtime 0.6.0-alpha.0 and four bigint resource estimates; three exact expectations updated',
