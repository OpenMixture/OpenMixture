...
icd_path="$swiftshader_directory/build/Linux/vk_swiftshader_icd.json"
test -f "$icd_path"
test -f "$swiftshader_directory/build/libvk_swiftshader.so"
cp "$swiftshader_directory/build/libvk_swiftshader.so" "$swiftshader_directory/build/Linux/libvk_swiftshader.so"
