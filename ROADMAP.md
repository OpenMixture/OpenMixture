...
| Current execution scope | [M6A-02 Core implementation](./docs/m6a-02-core-resources.md) delivers resource validation, snapshots and plan identity, gated by its implementation PR checks. Next is M6A-03 Native upload; browser resources and pixel qualification remain later tasks. |
