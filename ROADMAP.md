...
| Active increment | M6-B and NUM-01 implementation, bounded qualification and main integration are complete. Publication remains separate; no next feature is automatically started. |
